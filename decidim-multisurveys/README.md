...
A tool for Decidim that adds the ability to have multiple questionnaires into one single component.
...
```ruby
gem "decidim-multisurvey", git: "https://github.com/Platoniq/decidim-module-multisurvey"
```
...
```bash
bundle
bundle exec rails decidim_multisurvey:install:migrations
...
Multisurvey adds a new component to the Admin panel so administrators can add it to any Participatory Space.
