...
ActiveRecord::Schema.define(version: 20_210_409_130_291) do
  ...
  create_table "decidim_accountability_simple_result_details", force: :cascade do |t|
    ...
    t.index %w(accountability_result_detailable_id accountability_result_detailable_type), name: "index_decidim_accountability_simple_result_dets_on_detailable"
  end
