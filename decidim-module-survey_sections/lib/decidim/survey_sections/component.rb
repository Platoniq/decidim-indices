...
Decidim.register_component(:survey_sections) do |component|
  ...
  #   resource.model_class_name = "Decidim::SurveySections::SomeResource"
  #   resource.template = "decidim/survey_sections/some_resources/linked_some_resources"
  # end
